...
def start(client, message):
    ...
    message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton('𝐒𝐔𝐏𝐏𝐎𝐑𝐓 👬', url='https://t.me/Jkrish001'),
...
def a(client, message):
    ...
    try:
        ...
        m.edit('❌ 𝐄𝐫𝐫𝐨𝐫\n\n Report This Erorr To Fix @Jkrish001 ❤️')
        print(e)
    try:
